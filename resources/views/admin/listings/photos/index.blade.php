...
<div id="mainContent">
    <div class="row">
        ...
        <div class="col-md-2">
        <a href="{{route('admin.listings.edit', ['slug' => $slug, 'id' => $id])}}" class="btn cur-p "style="width: 100%;margin-top: 1rem; color: black;"> Back To Edit Page</a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    ...
                                    class="btn btn-outline-danger btn-color"
                                    style="
                                        width: 100%;
                                        margin-top: 1rem;
                                        color: black;">
